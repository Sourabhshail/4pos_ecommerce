...
class orderController {
    ...
    place_order = async (req, res) => {
        ...
        for (let i = 0; i < products.length; i++) {
            ...
            for (let j = 0; j < pro.length; j++) {
                let tempCusPro = {
                    ...
                    addons: pro[j].addons || [] // Capture the addons here
                };
        ...
        try {
            ...
            for (let i = 0; i < products.length; i++) {
                ...
                for (let j = 0; j < pro.length; j++) {
                    let tempPro = {
                        ...pro[j].productInfo,
                        quantity: pro[j].quantity,
                        addons: pro[j].addons || [] // Include addons here as well
                    };
            ...
            responseReturn(res, 500, { message: "Error placing order" }); // Send a response on error
        }
    };
