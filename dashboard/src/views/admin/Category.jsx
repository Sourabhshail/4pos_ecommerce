...
const Category = () => {
    ...
    return (
        <div className='px-2 lg:px-7 pt-5'>
            <div className='flex lg:hidden justify-between items-center mb-5 p-4 bg-[#ffffff] rounded-md'>
                <h1 className='text-[#000000] font-semibold text-lg'>Categorys</h1>
                    ...
                    <div className='w-full pl-5'>
                        <div className='bg-[#ffffff] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#000000]'>
                            <div className='flex justify-between items-center mb-4'>
                                <h1 className='text-[#000000] font-semibold text-xl'>Add Category</h1>
                                <div onClick={() => setShow(false)} className='block lg:hidden cursor-pointer'><GrClose className='text-[#000000]' /></div>
                            </div>
                            <form onSubmit={add_category}>
                                <div className='flex flex-col w-full gap-1 mb-3'>
                                    <label htmlFor="name">Category name</label>
                                    <input value={state.name} onChange={(e) => setState({ ...state, name: e.target.value })} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#ffffff] border border-slate-700 rounded-md text-[#000000]' type="text" id='name' name='category_name' placeholder='category name' required />
                                </div>
                                <div>

                                    <label className='flex justify-center items-center flex-col h-[238px] cursor-pointer border border-dashed hover:border-indigo-500 w-full border-[#000000]' htmlFor="image">
                                        {
