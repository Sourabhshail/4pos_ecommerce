...
const Footer = ({ sellerId }) => {
  ...
  const usefulLinks = [
    ...
    { name: "About our Shop", url: "about-our-shop" },
    { name: "Delivery Information", url: "delivery-information" },
        ...
        <div className="w-3/12 lg:w-4/12 sm:w-full">
          <div className="flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-2 text-slate-600">
              <li>Address : {supportInfo.address || "Not available"}</li>
              <li>Phone : {supportInfo.mobileNo || "Not available"}</li>
              <li>Email : {supportInfo.email || "Not available"}</li>
            </ul>
          </div>
        </div>
              ...
              <div className="flex justify-between gap-[80px] lg:gap-[40px]">
                <ul className="flex flex-col gap-2 text-slate-600 text-sm">
                  {usefulLinks.map((link, index) => (
                    <li key={index}>
                      <Link to={`/${sellerId}/page/${link.url}`}>
                        {link.name}
                      </Link>
                    </li>
                  ))}
