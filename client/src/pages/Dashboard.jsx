                        ...
                        <div className={` rounded-md z-50 md-lg:absolute ${filterShow ? '-left-4' : '-left-[360px]'} w-[270px] ml-4 bg-white`}>
                            <ul className='py-2 text-slate-600 px-4'>
                                <li className='flex justify-start items-center gap-2 py-2'>
                                    ...
                                    <Link  to={`/${sellerId}/dashboard`} className='block'>Dashboard</Link>
                                </li>
                                <li className='flex justify-start items-center gap-2 py-2'>
                                    <span className='text-xl'><RiProductHuntLine /></span>
                                    <Link  to={`/${sellerId}/dashboard/my-orders`} className='block'>My Orders</Link>
                                </li>
                                <li className='flex justify-start items-center gap-2 py-2'>
                                    <span className='text-xl'><BsHeart /></span>
                                    <Link to={`/${sellerId}/dashboard/my-wishlist`} className='block'>Wishlist</Link>
                                </li>
                                <li className='flex justify-start items-center gap-2 py-2'>
                                    <span className='text-xl'><BsChat /></span>
                                    <Link to={`/${sellerId}/dashboard/chat`} className='block'>Chat</Link>
                                </li>

                                {/* <li className='flex justify-start items-center gap-2 py-2'>
                                    <span className='text-xl'><TfiLock /></span>
                                    <Link  to={`/${sellerId}/dashboard/chage-password`} className='block'>Change Password</Link>
                                </li> */}
