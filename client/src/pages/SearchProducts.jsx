...
const SearchProducts = ({ sellerId }) => {
  ...
  useEffect(() => {
    dispatch(price_range_product(sellerId));
  }, []);
  useEffect(() => {
    setState({
      values: [
  ...
  useEffect(() => {
    if (latest_product && latest_product.length > 0) {
      const symbol = latest_product[0][0].currency || "";
          ...
          <div className="w-full flex flex-wrap">
              ...
              <div className="py-2 flex flex-col gap-5">
                ...
                <div>
                  <span className="text-red-500 font-bold text-lg">
                    {currencySymbol}
                    {Math.floor(state.values[0])} - {currencySymbol}
            ...
            <div className="w-9/12 md-lg:w-8/12 md:w-full">
              <div className="pl-8 md:pl-0">
                ...
                <div className="pb-8">
                  <ShopProducts products={products} styles={styles} sellerId={sellerId} />
                </div>
                <div>
